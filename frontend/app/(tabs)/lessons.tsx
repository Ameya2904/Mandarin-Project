            ...
            >
              <View style={styles.lessonRow}>
                <View style={styles.lessonNumber}>
                  <Text style={styles.lessonNumberText}>{item.lesson_number}</Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  lessonNumberText: { fontSize: fontSize.lg, color: colors.primary, fontWeight: '600' },
  lessonInfo: { flex: 1 },
  lessonTitle: { fontSize: fontSize.lg, color: colors.textPrimary, fontWeight: '500' },
  ...
  metaPillText: { fontSize: fontSize.xs, color: colors.textSecondary, fontWeight: '500' },
  ...
  lessonProgressFill: { height: '100%', backgroundColor: colors.primary, borderRadius: radius.full },
});
